...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('/') }}/public/asset/img/core-img/favicon.ico">
...
<body>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            <!-- Logo -->
                            <div class="logo">
                                <a href="index.html"><img src="{{ asset('/') }}/public/asset/img/core-img/logo.png" alt=""></a>
                            </div>
    ...
    <footer class="footer-area">
        ...
        <!-- jQuery-2.2.4 js -->
        <script src="{{ asset('/') }}/public/asset/js/jquery/jquery-2.2.4.min.js"></script>
        <!-- Popper js -->
        <script src="{{ asset('/') }}/public/asset/js/bootstrap/popper.min.js"></script>
        <!-- Bootstrap js -->
        <script src="{{ asset('/') }}/public/asset/js/bootstrap/bootstrap.min.js"></script>
        <!-- All Plugins js -->
        <script src="{{ asset('/') }}/public/asset/js/plugins/plugins.js"></script>
        <!-- Active js -->
